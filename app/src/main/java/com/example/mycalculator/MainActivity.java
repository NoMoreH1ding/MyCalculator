...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        theFirstView = (TextView) findViewById(R.id.theFirstView);
        theOptionView = (TextView) findViewById(R.id.theOptionView);
        theSecondView = (TextView) findViewById(R.id.theSecondView);
        theEqualView = (TextView) findViewById(R.id.theEqualView);
        theAnswerView = (TextView) findViewById(R.id.theAnswerView);
